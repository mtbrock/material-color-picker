...
function createPalette(palette = {}) {
    return Object.assign(palette, {
        primary: createColorGroup(muiColors.blue[600]),
        secondary: createColorGroup(muiColors.blueGrey[600]),
        error: createColorGroup(muiColors.red[600]),
        warning: createColorGroup(muiColors.deepOrange[700]),
        info: createColorGroup(muiColors.yellow[700]),
        success: createColorGroup(muiColors.green[700]),
    })
}
